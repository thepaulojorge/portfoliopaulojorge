...
const traducoes = {
  pt: {
    ...
    proj1Ver:      "↗ Ver app",
    proj2Titulo:   "Catálogo de Jogos",
    proj2Desc:     "Catálogo pessoal de jogos com estatísticas, busca, ordenação e sistema de avaliação. Inclui gráficos e exportação de dados.",
    proj2Ver:      "↗ Ver app",
...
proj5Ver:      "↗ Ver app",
  ...
  en: {
    ...
    proj1Ver:      "↗ View app",
    proj2Titulo:   "Game Catalog",
    proj2Desc:     "Personal game catalog with statistics, search, sorting and rating system. Includes charts and data export.",
    proj2Ver:      "↗ View app",
...
proj5Ver:      "↗ View app",
  ...
  fr: {
    ...
    proj1Ver:      "↗ Voir l'app",
    proj2Titulo:   "Catalogue de jeux",
    proj2Desc:     "Catalogue personnel de jeux avec statistiques, recherche, tri et système de notation. Inclut des graphiques et l'export de données.",
    proj2Ver:      "↗ Voir l'app",
...
proj5Ver:      "↗ Voir l'app",
  ...
  jp: {
    ...
    proj1Ver:      "↗ アプリを見る",
    proj2Titulo:   "ゲームカタログ",
    proj2Desc:     "統計、検索、並び替え、評価システムを備えた個人用ゲームカタログ。グラフとデータエクスポート機能付き。",
    proj2Ver:      "↗ アプリを見る",
...
document.querySelectorAll(".carrossel").forEach(carrossel => {
  ...
  function ir(n) {
    ...
    imgs[atual].classList.add("ativo");
